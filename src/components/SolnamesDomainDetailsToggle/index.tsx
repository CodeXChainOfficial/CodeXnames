...
type SolnamesDomainDetailsToggleProps = Omit<
...
const SolnamesDomainDetailsToggle: React.FC<
  SolnamesDomainDetailsToggleProps
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <Button className="bg-light_blue-A700 cursor-pointer font-inter font-semibold min-w-[165px] py-[9px] rounded-md text-base text-black-900_01 text-center">
...
SolnamesDomainDetailsToggle.defaultProps = {
  profiletext: "Profile",
  subdomainstext: "Subdomains",
  domaindetailstext: "Domain Details",
};

export default SolnamesDomainDetailsToggle;
